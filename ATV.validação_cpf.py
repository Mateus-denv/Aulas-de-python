...
2. CALCULO DO 2º DIGITO
    ...
    2.5 Foram ciaridas 2 lista, a 1º para armazena o valor que o usuario enviou, e a 2º para armazena o valor que o programa gerou.
    2.6 Se o resto for maior que 9 o penúltimo numero devera se torma 0, caso contrario permance o valor do resto.
"""
# ETAPA 1.
while True:
    # 1.1
    ...
    # 1.6
    resto_multip_por_10 = numeros_multip_por_10 % 11
    ...
    # 1.8
    if resto_multip_por_10 > 9:
        print(f"Este digito [{resto_multip_por_10}] não é valido e será substituido para '0'.")
        cpf_gerado_por_programa.pop(9)
        cpf_gerado_por_programa.insert(9, 0)
    else:
        print(f"Este digito [{resto_multip_por_10}] é valido.")
        cpf_gerado_por_programa.pop(9)
        cpf_gerado_por_programa.insert(9, resto_multip_por_10)
    print("Enviado por você: ",*cpf_enviador_por_user, sep="")
